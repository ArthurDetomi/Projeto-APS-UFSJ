...
public class Usuario {
	...
	public Usuario(String login, String password, String cpf, String nome, String telefone, String email,
			LocalDateTime editado, TipoUsuario tipoUsuario) {
		this.login = login;
		this.password = password;
		this.cpf = cpf;
		this.nome = nome;
	...
	public String toString() {
		return "Usuario{" + "id=" + id + ", login='" + login + '\'' + ", password='" + password + '\'' + ", cpf='" + cpf
				+ '\'' + ", nome='" + nome + '\'' + ", telefone='" + telefone + '\'' + ", email='" + email + '\''
				+ ", cadastrado=" + cadastrado + ", editado=" + editado + ", tipoUsuario=" + tipoUsuario + '}';
	}
